...
function LinkedInBadge() {
  ...
  return (
    <a href="https://ar.linkedin.com/in/nicolasvelasco1996" target="_blank" rel="noopener noreferrer" className="block no-underline group">
      <div style={{ backgroundColor: isDark ? "#1a1a1a" : "white" }} className="border border-[rgba(0,0,0,0.1)] rounded-2xl overflow-hidden w-[420px] shadow-sm hover:shadow-md transition-shadow duration-200">
        <div style={{ backgroundColor: isDark ? "#111111" : "#f3f2f0" }} className="px-8 py-5">
        ...
        <div className="px-8 py-7">
          ...
          <p style={{ color: isDark ? "#e8e8e8" : "#111827" }} className="font-bold text-[1.2rem] leading-tight mb-2">Nicolas Velasco</p>
          <p style={{ color: isDark ? "#9ca3af" : "#4b5563" }} className="text-[0.88rem] leading-snug mb-4">Desarrollador Back-end | Java | Springboot | TypeScript | Docker | Vercel | NestJS</p>
