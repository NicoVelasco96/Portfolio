      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-12">
        ...
        <div className="flex flex-col flex-1">
          ...
          <div className="flex gap-3 flex-wrap relative reveal">
            <a
              href="#proyectos"
              className="bg-gradient-to-br from-brand-pink to-brand-pink-dark text-white px-6 sm:px-8 py-3 rounded-xl font-medium no-underline hover:-translate-y-0.5 hover:opacity-90 transition-all duration-200"
            >
              {t.hero.cta_projects}
            </a>
            <a
              href="#contacto"
              className="border border-[rgba(0,0,0,0.15)] dark:border-[rgba(255,255,255,0.4)] text-text dark:text-white bg-white dark:bg-transparent px-6 sm:px-8 py-3 rounded-xl font-medium no-underline hover:bg-bg-3 dark:hover:bg-white/10 transition-colors duration-200"
            >
              {t.hero.cta_contact}
            </a>
          </div>
