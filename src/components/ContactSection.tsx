...
function ContactButton({ link }: { link: ContactLink }) {
  ...
  return (
    <a
      ...
      className="flex items-center gap-2.5 px-5 sm:px-6 py-3 rounded-xl font-medium text-[0.88rem] sm:text-[0.9rem] no-underline transition-all duration-300 hover:-translate-y-1 border border-[rgba(0,0,0,0.08)] shadow-sm hover:shadow-md"
      style={{
...
export default function ContactSection() {
  const { t } = useApp();
  return (
    <section id="contacto" className="py-24 px-4 sm:px-8 md:px-16 bg-bg relative">
      <div className="max-w-[620px] mx-auto text-center">
        ...
        <div className="flex gap-3 sm:gap-4 justify-center flex-wrap reveal">
